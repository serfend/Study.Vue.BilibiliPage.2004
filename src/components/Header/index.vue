<template>
  <div class="app-header">
    <nav-menu :leftNav="leftNav" :headBanner="headBanner" :menuShow="menuShow" />
        ...
        <div class="bili-wrapper head-content">
          <div class="search">
            <div class="searchform">
              ...
              />
              <button type="submit" class="search-submit" @click="searchALL()" />
            </div>
          ...
          <ul class="nav-menu">
            ...
            >
              ...
              <ul class="sub-nav" v-if="item.items">
                <li v-for="(navitem, ind) in item.items" :key="`sub_navs_item_${ind}`">
                  <a :href="navitem.href">
            ...
            >
              ...
              <div class="sub-nav" v-if="item.fieldClass != ''" :class="item.fieldClass">
                <ul>
                  <li v-for="(itemnav, index) in item.fields" :key="`item_fields_${index}`">
                    <a :href="itemnav.href">
  ...
  methods: {
    ...
    searchALL() {
      if (this.searchValue === "") {
        this.$router.push({
          path: "/search/all",
          query: { keyword: this.searchWord.word }
        });
      } else {
        this.$router.push({
          path: "/search/all",
